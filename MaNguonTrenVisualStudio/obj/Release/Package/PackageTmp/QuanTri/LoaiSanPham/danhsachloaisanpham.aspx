<%@ Page Title="" Language="C#" MasterPageFile="~/QuanTri/Site1.Master" AutoEventWireup="true" CodeBehind="danhsachloaisanpham.aspx.cs" Inherits="WebApplication2.QuanTri.LoaiSanPham.danhsachloaisanpham" %>
    ...
    <style> 
     ...
     <div id="admincon">
			...
			<div id="sanphammoi">
				<table scrolling="yes">
					...
					<tr class="sanphammoitheongay">
						<td colspan=1000>DANH MỤC SẢN PHẨM</td>
					</tr>
        ...
        <%@Import Namespace="System.Data.SqlClient" %>
                        <%
                            string sql =
  " SELECT lsp.id_loai_san_pham,  lsp.ten_loai_san_pham,  lsp.anh_loai_san_pham,  lsp.bieu_tuong_loai_san_pham,  lsp.cap_do_loai_san_pham,  sl.sl " +
                   ...
                   %>
                    <%
                        ...
                        "</a>"+"</td>" +
                                            ...
                                            "  <td><span class=class"+ds.Rows[i][3].ToString().Replace("\\","")+"></span></td> " +
                                            "  <td >" + ds.Rows[i][4].ToString() + "</td> " +
                                            "   <td ><a href=./danhsachloaisanphamcap1.aspx?id_loai_san_pham=" + ds.Rows[i][0].ToString() + ">" + ds.Rows[i][5].ToString() + " </a></td " +
                                           "   </tr> "
