<%@ Page Title="" Language="C#" MasterPageFile="~/QuanTri/Site1.Master" AutoEventWireup="true" CodeBehind="them.aspx.cs" Inherits="WebApplication2.QuanTri.NhanVien.them" %>
       ...
       <div id="sanphammoi">
				<table scrolling="yes">
					<tr class="sanphammoitheongay">
						<td colspan=1000>THÊM NHÂN VIÊN</td>
					</tr>
                    </table>
           </div>
                                <br />
                                <table style="width: 711px; height: 100px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 366px; height: 20px">
                                            <asp:TextBox ID="TextBox0" runat="server" Width="400px" TextMode="Email"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 366px; height: 20px">
                                            <asp:TextBox ID="TextBox1" runat="server" Width="400px" TextMode="Password"></asp:TextBox>
