<%@ Page Title="" Language="C#" MasterPageFile="~/QuanTri/Site1.Master" AutoEventWireup="true" CodeBehind="sua.aspx.cs" Inherits="WebApplication2.QuanTri.PhieuNhap.sua" %>
       ...
       <div id="sanphammoi">
				<table scrolling="yes">
					...
					<tr class="sanphammoitheongay">
						<td colspan=1000>SỬA PHIẾU NHẬP</td>
					</tr>
                    </table>
           </div>
                                <br />
                                <table style="width: 711px; height: 100px;">
                                    <tr>
                                        ...
                                        <td style="width: 178px; height: 20px">ID phiếu nhập</td>
                                        <td style="width: 366px; height: 20px">
                                            <asp:TextBox ID="TextBox6" runat="server" Enabled="False" Width="200px"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 23px; height: 20px">&nbsp;</td>
                                        <td style="width: 178px; height: 20px">Tên người tạo phiếu</td>
                                        <td style="width: 366px; height: 20px">
                                            <asp:TextBox ID="TextBox7" runat="server" Enabled="False" Width="200px"></asp:TextBox>
                                        </td>
                                        <td style="width: 178px; height: 20px">&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 23px; height: 20px">&nbsp;</td>
                                        <td style="width: 178px; height: 20px">Ngày tạo phiếu</td>
                                        <td style="width: 366px; height: 20px">
                                            <asp:TextBox ID="TextBox8" runat="server" Enabled="False" Width="200px"></asp:TextBox>
                                        </td>
                                        <td style="width: 178px; height: 20px">&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 23px; height: 20px"></td>
                                        <td style="width: 178px; height: 20px">Kho hàng nhập vào</td>
                                        <td style="width: 366px; height: 20px">
                                            <asp:DropDownList Width="200px" ID="DropDownList1" runat="server" Enabled="False">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="width: 178px; height: 20px"></td>
                                    </tr>
