<%@ Page Title="" Language="C#" MasterPageFile="~/QuanTri/Site1.Master" AutoEventWireup="true" CodeBehind="them.aspx.cs" Inherits="WebApplication2.QuanTri.GiamGia.them" %>
                                ...
                                <table style="width: 711px; height: 100px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 366px; height: 20px">
                                            <asp:TextBox ID="TextBox2" runat="server" Width="181px" MaxLength="5"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 366px; height: 21px">
                                            <asp:TextBox ID="TextBox4" runat="server"  Width="181px"  TextMode="DateTime" ReadOnly="True"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 20px; width: 366px" aria-autocomplete="none">
                                            <asp:TextBox ID="TextBox5" runat="server" Width="181px"  TextMode="DateTime" ReadOnly="True"></asp:TextBox>
                                            <img src="calender.png" />
