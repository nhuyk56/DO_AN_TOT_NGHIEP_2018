<%@ Page Title="" Language="C#" MasterPageFile="~/QuanTri/Site1.Master" AutoEventWireup="true" CodeBehind="them.aspx.cs" Inherits="WebApplication2.QuanTri.KhoHang.them" %>
       ...
       <div id="sanphammoi">
				<table scrolling="yes">
					...
					<tr class="sanphammoitheongay">
						<td colspan=1000>THÊM KHO HÀNG</td>
					</tr>
                    </table>
           </div>
                                <br />
