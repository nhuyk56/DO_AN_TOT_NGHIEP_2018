<%@ Page Title="" Language="C#" MasterPageFile="~/QuanTri/Site1.Master" AutoEventWireup="true" CodeBehind="themsp.aspx.cs" Inherits="WebApplication2.QuanTri.GiamGia.themsp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%
        ...
        try
        {
            ...
            sql = "select count(*) from danh_sac_san_pham_giam_gia where id_giam_gia=" + id_giam_gia;
            ds = new System.Data.DataTable();
            new System.Data.SqlClient.SqlDataAdapter(new System.Data.SqlClient.SqlCommand(sql, ketnoi)).Fill(ds);
            if (int.Parse(ds.Rows[0][0].ToString()) >= 20)
            {
                loi = "Một chương trình giảm giá không thể có số lượng sản phẩm tham gia lớn hơn 20!";
                int.Parse("a");
            }
     ...
     <div id="admincon">
      ...
      <div id="admincon">
			<div id="sanphammoi">
				<table scrolling="yes">
					<tr class="sanphammoitheongay">
						<td colspan=1000>SẢN PHẨM CHUẨN BỊ SỬA TRONG CHƯƠNG TRÌNH GIẢM GIÁ</td>
					</tr>
					<tr class="tieudespmoi">
						<td>ID</td>
                        <td>Tên</td>
